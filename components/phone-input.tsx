...
>(({ className, ...props }, ref) => (
  <Input
    className={cn('text-foreground rounded-s-none rounded-e-lg', className)}
    {...props}
    ref={ref}
  />
));
...
const CountrySelect = ({
  ...
  // Set default country if no country is selected
  React.useEffect(() => {
    if (!selectedCountry && defaultCountry) {
      onChange(defaultCountry);
    }
  }, [selectedCountry, defaultCountry, onChange]);
      ...
      <PopoverTrigger asChild>
        ...
        >
          <FlagComponent
            ...
            countryName={selectedCountry || defaultCountry}
          />
          <ChevronsUpDown
            className={cn(
